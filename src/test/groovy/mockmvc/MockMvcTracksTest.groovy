...
import cz.upce.music.controller.TrackController
...
class MockMvcTracksTest {
    ...
    void statusOkTest() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get("/"))
                ...
                .andExpect(MockMvcResultMatchers.view().name("track-list"))
                .andExpect(MockMvcResultMatchers.model().attributeExists("trackList"));
    }
}
